...
input_file="shuffled-00-only.txt"

# Get the number of lines in the input file
total_lines=$(wc -l < "$input_file")

# Output files
eval_file="eval-00.txt"
test_file="test-00-Large.txt"

# Number of lines in eval set
eval_lines=27000

# Start and end lines for test set
# NOTE: We included the first 1000000 lines in the train-1M-00.txt train set
